...
### Additional Changes:
1. **Removed Unnecessary Comments**: Removed comments that were not necessary for understanding the code.
2. **Consistent Formatting**: Ensured consistent formatting and spacing to match the gold code's style.
